...
if (window.itResources.length === 0) {
    window.itResources = [{
        ...
        },
        {
            ...
            description: "Официальная документация и руководства по разработке под Android от Google.",
            link: "https://developer.android.com/guide",
            tags: ["android", "документация", "google", "мобильная разработка", "официальный"],
            type: "reference",
            category: "mobile-dev",
            subcategory: "android",
            dateAdded: new Date().toISOString()
        },
        {
            ...
            description: "Официальная документация по разработке под iOS от Apple.",
            link: "https://developer.apple.com/documentation/",
            tags: ["ios", "документация", "apple", "мобильная разработка", "swift"],
            type: "reference",
            category: "mobile-dev",
            subcategory: "ios",
            dateAdded: new Date().toISOString()
        },
        {
            id: 298,
            title: "React Native",
            description: "Фреймворк для создания нативных мобильных приложений с использованием React и JavaScript.",
            link: "https://reactnative.dev/",
            tags: ["react", "javascript", "кроссплатформенный", "мобильная разработка", "библиотека"],
            type: "библиотеки",
            category: "mobile-dev",
        ...
        },
        {
            id: 299,
            title: "Flutter",
            description: "UI toolkit от Google для создания кроссплатформенных приложений из единой codebase.",
            link: "https://flutter.dev/",
            tags: ["flutter", "dart", "кроссплатформенный", "google", "ui toolkit"],
            type: "framework",
            category: "mobile-dev",
            subcategory: "cross-platform",
            dateAdded: new Date().toISOString()
        },
        {
            id: 300,
            title: "Retrofit",
            description: "Библиотека для Type-safe HTTP клиентов в Android и Java.",
            link: "https://square.github.io/retrofit/",
            tags: ["android", "библиотека", "http", "networking", "rest api"],
            type: "библиотеки",
            category: "mobile-dev",
        ...
        },
        {
            ...
            description: "Полная документация по сервисам Amazon Web Services.",
            link: "https://docs.aws.amazon.com/",
            tags: ["aws", "документация", "облачные вычисления", "amazon", "сервисы"],
            type: "reference",
            category: "cloud",
            subcategory: "aws",
            dateAdded: new Date().toISOString()
        },
        {
            ...
            description: "Официальная документация по Microsoft Azure облачной платформе.",
            link: "https://docs.microsoft.com/azure/",
            tags: ["azure", "документация", "microsoft", "облачные вычисления", "сервисы"],
            type: "reference",
            category: "cloud",
            subcategory: "azure",
            dateAdded: new Date().toISOString()
        },
        {
            ...
            description: "Документация по Google Cloud Platform и сервисам.",
            link: "https://cloud.google.com/docs",
            tags: ["gcp", "документация", "google", "облачные вычисления", "сервисы"],
            type: "reference",
            category: "cloud",
            subcategory: "gcp",
            dateAdded: new Date().toISOString()
        },
        {
            id: 304,
            title: "Terraform",
            description: "Инструмент для Infrastructure as Code (IaC) от HashiCorp.",
            link: "https://www.terraform.io/",
            tags: ["iac", "devops", "инфраструктура", "automation", "библиотека"],
            type: "библиотеки",
            category: "cloud",
            subcategory: "devops",
            dateAdded: new Date().toISOString()
        },
        {
            id: 305,
            title: "Kubernetes",
            description: "Платформа для оркестрации контейнеров с открытым исходным кодом.",
            link: "https://kubernetes.io/",
            tags: ["контейнеры", "оркестрация", "devops", "docker", "библиотека"],
            type: "библиотеки",
            category: "cloud",
        ...
        },
        {
            id: 306,
            title: "Boto3",
            description: "AWS SDK для Python, позволяющий взаимодействовать с сервисами AWS.",
            link: "https://boto3.amazonaws.com/v1/documentation/api/latest/index.html",
            tags: ["aws", "python", "sdk", "api", "библиотека"],
            type: "библиотеки",
            category: "cloud",
            subcategory: "aws-sdk",
            dateAdded: new Date().toISOString()
        },
        {
            id: 307,
            title: "NumPy",
            description: "Фундаментальная библиотека для научных вычислений в Python с поддержкой многомерных массивов.",
            link: "https://numpy.org/",
            tags: ["python", "библиотека", "научные вычисления", "массивы", "математика"],
            type: "библиотеки",
            category: "data-science",
        ...
        },
        {
            ...
            tags: ["python", "библиотека", "визуализация", "графики", "data visualization"],
            type: "библиотеки",
            category: "data-science",
        ...
        },
        {
            id: 309,
            title: "Seaborn",
            description: "Библиотека для статистической визуализации данных на основе Matplotlib с улучшенным дизайном.",
            link: "https://seaborn.pydata.org/",
            tags: ["python", "библиотека", "визуализация", "статистика", "графики"],
            type: "библиотеки",
            category: "data-science",
            subcategory: "data-visualization",
            dateAdded: new Date().toISOString()
        },
        {
            id: 310,
            title: "Keras",
            description: "Высокоуровневый API для нейронных сетей, работающий поверх TensorFlow и других бэкендов.",
            link: "https://keras.io/",
            tags: ["python", "библиотека", "нейросети", "deep learning", "машинное обучение"],
            type: "библиотеки",
            category: "data-science",
        ...
        },
        {
            id: 311,
            title: "Glide",
            description: "Библиотека для загрузки и кэширования изображений в Android с простым API.",
            link: "https://github.com/bumptech/glide",
            tags: ["android", "библиотека", "изображения", "кэширование", "github"],
            type: "библиотеки",
            category: "mobile-dev",
            subcategory: "android-libraries",
            dateAdded: new Date().toISOString()
        },
        {
            id: 312,
            title: "Dagger",
            description: "Библиотека для dependency injection в Java и Android приложениях.",
            link: "https://dagger.dev/",
            tags: ["android", "библиотека", "dependency injection", "java", "di"],
            type: "библиотеки",
            category: "mobile-dev",
            subcategory: "android-libraries",
            dateAdded: new Date().toISOString()
        },
        {
            id: 313,
            title: "Alamofire",
            description: "Elegant HTTP Networking библиотека для Swift и iOS разработки.",
            link: "https://github.com/Alamofire/Alamofire",
            tags: ["ios", "библиотека", "networking", "http", "swift"],
            type: "библиотеки",
            category: "mobile-dev",
        ...
        },
        {
            id: 314,
            title: "SnapKit",
            description: "DSL для Auto Layout в iOS, делающий верстку кодом более простой и читаемой.",
            link: "https://github.com/SnapKit/SnapKit",
            tags: ["ios", "библиотека", "autolayout", "ui", "swift"],
            type: "библиотеки",
            category: "mobile-dev",
            subcategory: "ios-libraries",
            dateAdded: new Date().toISOString()
        },
        {
            id: 315,
            title: "AWS CDK",
            description: "Фреймворк для определения cloud infrastructure через знакомые языки программирования.",
            link: "https://aws.amazon.com/cdk/",
            tags: ["aws", "библиотека", "iac", "infrastructure", "cloudformation"],
            type: "библиотеки",
            category: "cloud",
            subcategory: "aws-tools",
            dateAdded: new Date().toISOString()
        },
        {
            id: 316,
            title: "Pulumi",
            description: "Modern Infrastructure as Code платформа, позволяющая использовать языки программирования для управления инфраструктурой.",
            link: "https://www.pulumi.com/",
            tags: ["iac", "библиотека", "мультиклауд", "infrastructure", "devops"],
            type: "библиотеки",
            category: "cloud",
        ...
        },
        {
            id: 317,
            title: "Helm",
            description: "Менеджер пакетов для Kubernetes, упрощающий deployment приложений.",
            link: "https://helm.sh/",
            tags: ["kubernetes", "библиотека", "devops", "deployment", "charts"],
            type: "библиотеки",
            category: "cloud",
        ...
        },
        {
            id: 318,
            title: "Prometheus",
            description: "Система мониторинга и алертинга с открытым исходным кодом для cloud-native environments.",
            link: "https://prometheus.io/",
            tags: ["мониторинг", "библиотека", "devops", "metrics", "observability"],
            type: "библиотеки",
            category: "cloud",
        ...
        },
        {
            id: 319,
            title: "Scapy",
            description: "Мощная интерактивная библиотека для манипуляции пакетами и сетевого сканирования на Python.",
            link: "https://scapy.net/",
            tags: ["python", "библиотека", "сетевая безопасность", "packet manipulation", "scanning"],
            type: "библиотеки",
            category: "cybersecurity",
        ...
        },
        {
            id: 320,
            title: "Requests",
            description: "Элегантная и простая библиотека для HTTP запросов в Python, часто используемая в security tools.",
            link: "https://docs.python-requests.org/",
            tags: ["python", "библиотека", "http", "web requests", "networking"],
            type: "библиотеки",
            category: "cybersecurity",
            subcategory: "web-security",
            dateAdded: new Date().toISOString()
        },
        {
            id: 321,
            title: "Cryptography",
            description: "Библиотека предоставляющая криптографические рецепты и примитивы для Python.",
        ...
        },
        {
            id: 322,
            title: "Impacket",
            description: "Коллекция классов Python для работы с сетевыми протоколами низкого уровня.",
            link: "https://github.com/SecureAuthCorp/impacket",
            tags: ["python", "библиотека", "network protocols", "pentesting", "github"],
            type: "библиотеки",
            category: "cybersecurity",
            subcategory: "network-security",
            dateAdded: new Date().toISOString()
    ...
    window.customizationResources = [{
            id: 1001,
            title: "Make Linux Mint Cinnamon Desktop Look Cool",
            description: "Видеоурок по кастомизации рабочего стола Linux Mint Cinnamon для придания современного и стильного вида.",
            link: "https://www.youtube.com/watch?v=zinD2N377Ko",
            tags: ["linux", "mint", "cinnamon", "кастомизация", "видео", "desktop", "customization"],
            type: "video",
            category: "linux",
            subcategory: "mint",
            dateAdded: new Date().toISOString()
        ...
        {
            id: 1002,
            title: "THE MOST BEAUTIFUL ARCH LINUX HYPRLAND SETUP (ML4W)",
            description: "Руководство по созданию красивого окружения Arch Linux с использованием оконного менеджера Hyprland.",
            link: "https://www.youtube.com/watch?v=nI90XPjr7bI",
            tags: ["arch linux", "hyprland", "кастомизация", "видео", "wayland", "customization", "красивый"],
            type: "video",
            category: "linux",
            subcategory: "arch",
            dateAdded: new Date().toISOString()
        ...
        {
            id: 1003,
            title: "How To Make Cinnamon Beautiful",
            description: "Подробное руководство по улучшению внешнего вида Cinnamon desktop environment.",
            link: "https://youtu.be/Q_Uoe5H4ORs?si=WS76MGjemiy8S8Tw",
            tags: ["cinnamon", "кастомизация", "видео", "linux", "desktop", "customization", "beautify"],
            type: "video",
            category: "linux",
            dateAdded: new Date().toISOString()
        },
        {
            id: 1004,
            title: "How to Customize Your Cinnamon Desktop Look Like MacOS Big Sur",
            description: "Превратите ваш Cinnamon desktop в интерфейс, похожий на macOS Big Sur.",
            link: "https://www.youtube.com/watch?v=DMs7DX3Um9E",
            tags: ["cinnamon", "macos", "big sur", "кастомизация", "видео", "linux", "customization"],
            type: "video",
            category: "linux",
            dateAdded: new Date().toISOString()
        },
        {
            ...
            description: "Использование темы Orchis GTK для придания вашему Cinnamon desktop свежего и элегантного вида.",
            link: "https://www.youtube.com/watch?v=npn8ZktlKEs",
            tags: ["cinnamon", "gtk", "orchis", "тема", "кастомизация", "видео", "elegant"],
            type: "video",
            category: "linux",
            dateAdded: new Date().toISOString()
        },
        {
            id: 1006,
            title: "Cinnamon Desktop Customization | Nord Color Theme",
            description: "Кастомизация Cinnamon desktop с использованием популярной Nord цветовой схемы.",
            link: "https://www.youtube.com/watch?v=h1yIY1BwetQ",
            tags: ["cinnamon", "nord", "цветовая схема", "кастомизация", "видео", "theme"],
            type: "video",
            category: "linux",
            dateAdded: new Date().toISOString()
        },
        {
            id: 1007,
            title: "Final Result - Give Your Linux Mint Cinnamon Edition look Warm and Aesthetic with Gruvbox Color",
            description: "Финальный результат кастомизации Linux Mint Cinnamon с теплой и эстетичной цветовой схемой Gruvbox.",
            link: "https://www.youtube.com/watch?v=hXw8eB7XhVM",
            tags: ["linux mint", "cinnamon", "gruvbox", "цветовая схема", "кастомизация", "видео", "aesthetic"],
            type: "video",
            category: "linux",
            subcategory: "mint",
            dateAdded: new Date().toISOString()
        ...
        {
            id: 1008,
            title: "Modernize Your Mint (Cinnamon Edition)",
            description: "Современная кастомизация Linux Mint Cinnamon Edition для придания современного вида.",
            link: "https://www.youtube.com/watch?v=hXw8eB7XhVM",
            tags: ["linux mint", "cinnamon", "modern", "кастомизация", "видео", "customization"],
            type: "video",
            category: "linux",
            subcategory: "mint",
            dateAdded: new Date().toISOString()
        ...
        {
            id: 1009,
            title: "Windows 11 Customization: Complete Guide",
            description: "Полное руководство по кастомизации Windows 11: темы, иконки, панель задач и многое другое.",
            link: "https://www.youtube.com/watch?v=example1",
            tags: ["windows 11", "кастомизация", "видео", "customization", "темы", "иконки"],
            type: "video",
            category: "windows",
            subcategory: "windows11",
            dateAdded: new Date().toISOString()
        ...
        {
            id: 1010,
            title: "How to Make Windows 10 Look Like macOS",
            description: "Превращение интерфейса Windows 10 в подобие macOS с помощью тем и утилит.",
            link: "https://www.youtube.com/watch?v=example2",
            tags: ["windows 10", "macos", "кастомизация", "видео", "customization", "темы"],
            type: "video",
            category: "windows",
            subcategory: "windows10",
            dateAdded: new Date().toISOString()
        ...
        {
            id: 1011,
            title: "Rainmeter Skins for Windows Customization",
            description: "Лучшие скины Rainmeter для кастомизации рабочего стола Windows.",
            link: "https://www.youtube.com/watch?v=example3",
            tags: ["windows", "rainmeter", "скины", "кастомизация", "видео", "desktop"],
            type: "video",
            category: "windows",
            dateAdded: new Date().toISOString()
        },
        {
            id: 1012,
            title: "Windows Terminal Customization Guide",
            description: "Полное руководство по кастомизации Windows Terminal: темы, шрифты, настройки.",
            link: "https://www.youtube.com/watch?v=example4",
            tags: ["windows", "terminal", "кастомизация", "видео", "customization", "темы"],
            type: "video",
            category: "windows",
            subcategory: "terminal",
            dateAdded: new Date().toISOString()
        ...
        {
            id: 1013,
            title: "Python Workout: 200 ten-minute exercises (2nd Edition)",
            description: "200 коротких упражнений по 10 минут для регулярной практики Python. Структуры данных, ООП, функциональное программирование, генераторы и работа с файлами.",
            link: "https://t.me/archivator_archive/7981",
            tags: ["python", "practice", "oop", "fp"],
            type: "book",
            category: "programming",
            subcategory: "python",
            dateAdded: new Date().toISOString()
        ...
        {
            id: 1014,
            title: "Полное руководство по PyQt6",
            description: "Руководство для новичков по созданию окон, интерфейсов и подключению виджетов в PyQt6.",
            link: "https://habr.com/ru/companies/skillfactory/articles/599599/",
        ...
        {
            id: 1015,
            title: "Создаем собственную нейронку на Python с нуля",
            description: "Практический разбор создания нейронной сети без библиотек глубокого обучения.",
            link: "https://habr.com/ru/articles/725668/",
...

        {
            ...
            description: "Инструмент для управления Docker-образами, анализа файловых систем и логов контейнеров.",
        ...
        {
            id: 1017,
            title: "Сборник по DevOps для разработчиков и инженеров",
            description: "Гайды, практики, инструменты и дорожные карты по DevOps в одном репозитории.",
        ...
        {
            id: 1018,
            title: "CodeViz — визуализация архитектуры проектов",
            description: "VS Code расширение для графического отображения структуры проекта с AI-помощником.",
            link: "https://marketplace.visualstudio.com/items?itemName=CodeViz.codeviz",
            tags: ["vscode", "architecture"],
            type: "tool",
            category: "tools",
            subcategory: "vscode-extensions",
            dateAdded: new Date().toISOString()
        },

        {
            id: 1019,
            title: "audioghost-ai",
            description: "AI-инструмент для извлечения конкретных звуков из аудиофайлов по текстовому запросу.",
            link: "https://github.com/0x0funky/audioghost-ai",
            tags: ["ai", "audio", "typescript"],
            type: "library",
            category: "programming",
        ...
        {
            id: 1020,
            title: "Doka — документация по HTML, CSS и JavaScript",
            description: "Современная и понятная документация по фронтенд-разработке с интерактивными примерами.",
            link: "https://doka.guide/",
...

        {
            ...
            description: "Руководство по пентесту и безопасности с использованием Kali Linux и NetHunter.",
            link: "https://t.me/IT_obrazovach/118",
            tags: ["security", "pentest", "kali"],
            type: "book",
            category: "security",
            subcategory: "pentesting",
            dateAdded: new Date().toISOString()
...

        {
            ...
            description: "Подробный видеоразбор Kubernetes: pods, deployments, services, ingress, secrets.",
            link: "https://www.youtube.com/watch?v=L3tgJXsMUTU",
